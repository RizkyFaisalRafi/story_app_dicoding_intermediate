...
import 'package:story_app_dicoding_intermediate/presentation/view/ui/custom_camera/camera_screen.dart';
import '../../../domain/entities/add_new_story_entity.dart';
import '../../../domain/use_case/get_token_usecase.dart';

class AddStoryUserProvider extends ChangeNotifier {
  ...
  PostAddUserStory postAddUserStory;

  final GetTokenUseCase getTokenUseCase;

  AddStoryUserProvider(
    this.getTokenUseCase, {
    required this.postAddUserStory,
  });
  ...
  Future<void> submitStoryUser(BuildContext context) async {
    ...
    try {
      ...
      final result = await postAddUserStory.execute(
        description,
        imageBytes!,
        1.2,
        1.2,
